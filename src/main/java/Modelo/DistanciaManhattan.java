...
public class DistanciaManhattan {
    ...
    public double calculaDistancia(Estacion estacion1, Estacion estacion2) {
        ...
        double dlat_rad = Math.toRadians(estacion2.latitud - estacion1.latitud);
        double dlon_rad = Math.toRadians(estacion2.longitud - estacion1.longitud);
        double lat_media_rad = Math.toRadians((estacion1.latitud + estacion2.latitud) / 2);
